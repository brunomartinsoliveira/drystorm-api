...
Diagrama do ecossistema: landing page → API REST → PostgreSQL; e-mails transacionais assíncronos; rotas administrativas com JWT.

![Visão geral da arquitetura DryStorm API](assets/drystorm-api-diagram.png)
